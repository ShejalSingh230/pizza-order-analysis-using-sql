...
-- Data Cleaning for Orders_Details Table
-- Checking null values in columns
...
-- Q3) Identify the highest priced prizza...
SELECT 
...
-- Q9) Group the orders by date and calculate teh average number of pizzas ordered per day...
SELECT 
...
-- Q10) Determine the top three most ordered pizza types based on revenue...
SELECT 
    pizza_types.name,
